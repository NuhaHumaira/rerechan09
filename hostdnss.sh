...
DOMAIN=rerechanstore.eu.org
SUB_DOMAIN=vpn-${sub}.rerechanstore.eu.org
NS_DOMAIN=ns-${subsl}.rerechanstore.eu.org
CF_ID=widyabakti02@gmail.com
CF_KEY=c97cc106a957747e35470bdf56e2dd6cbace5

echo "IP=""$SUB_DOMAIN" >> /var/lib/aixxy7-pro/subdomain.conf
